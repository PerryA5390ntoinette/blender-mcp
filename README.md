...
>
> **My setup:** Running on Ubuntu 22.04 with Blender 4.2. Had no issues. On Linux, just use `pip install uv` or the curl installer below — no need for brew or powershell.
